    ...
    <header id="header" role="banner">
        ...
        <nav className="header__menu">
            <ul className='menu'>
                ...
                <li>
                    <a href="/today"><CiCoins1 />추천영상</a>
                </li>
                <li>
                    <a href="/developer"><CiBoxes />추천 개발자</a>
                </li>
                <li>
                    <a href="/webd"><CiBullhorn />웹디자인 기능사</a>
                </li>
                <li>
                    <a href="/website"><CiCoffeeCup />웹표준 사이트</a>
                </li>
            </ul>
